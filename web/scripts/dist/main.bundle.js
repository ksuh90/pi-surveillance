...
module.exports = React.createClass({
    ...
    render: function render() {
        ...
        var rows = $.map(controls, function (row, key) {
            return React.createElement(Control, { key: key, row: row, app: that.props.app });
        });
...
var Control = React.createClass({
    ...
    controlClick: function controlClick(option) {
        var that = this;
    ...
    render: function render() {
        return React.createElement(
            'div',
            { className: 'jumbotron control-slot' },
            React.createElement(
                'h3',
                null,
            ...
            React.createElement(
                'button',
                {
                    ...
                    'data-option': this.props.row.option },
                this.props.row.label
            )
        );
    }
...
},{"./StatusAlert.jsx":163,"react":158}],160:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({
    ...
    render: function render() {
        ...
        var rows = $.map(that.state.log, function (v, k) {
            return React.createElement(LogRow, { doc: v, key: k, app: that.props.app });
        });
        ...
        return React.createElement(
            ...
            React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement('img', { className: 'img-responsive', src: src })
                )
            ),
            React.createElement(
                'div',
...
var Container = React.createClass({
    ...
    componentDidMount: function componentDidMount() {},
    handleNavClick: function handleNavClick(navKey) {
        this.setState({
    ...
    render: function render() {
        ...
        var nav = {
            log: {
                component: React.createElement(Log, props),
                label: 'Log'
            },
            controlPanel: {
                component: React.createElement(ControlPanel, props),
                label: 'Control Panel'
            }
        };
        return React.createElement(
...
// Entry point
ReactDOM.render(React.createElement(Container, { app: APP }), document.getElementById('container'));

},{"./ControlPanel.jsx":159,"./Log.jsx":160,"./Nav.jsx":162,"react":158,"react-dom":2}],162:[function(require,module,exports){
'use strict';
...
module.exports = React.createClass({
    ...
    render: function render() {
        return React.createElement(
            'div',
            { className: this.statusClass, role: 'alert' },
            React.createElement(
                'strong',
                null,
                this.props.msg
